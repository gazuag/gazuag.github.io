---
title: "Juridik: Svenska - Rumänska"
---
...
| Åhörare | auditoriu |
| Åklagarbrott | Acțiune judiciară inițiată de către procuror |
| Åklagare | Procuror |
...
| Allmänna arvsfonden | Fond public de succesiune |
...
| Ansvarsförsäkring | Asigurare de răspundere civilă |
...
| Återbetalningsskyldig | Obligația restituirii plății |
...
| Avtal | Acord |
| Avtal om sammanlevnad i oskiftat bo | Acord de coabitare în nepartajare |
...
| Beroendeställning | Poziție de dependență |
...
| Domslut | Dispozitivul hotărârii judecătorești |
...
| Enkel borgen | Garanție /fidejusiune simplă |
...
| Europaparlamentet | Parlamentul european |
...
| Falskt åtal och obefogat åtal | Acțiune judiciară inițiată p emotive false /nemotivată |
...
| Finansiell rådgivning | Consiliere financiară |
...
| Förledande av ungdom | Ademenirea/seducția minorului |
...
| Försvarsplikt | Datoria de apărare a țării |
...
| Fotokonfrontation | Confruntare fotografică |
...
| Funktionsnedsättning | Dizabilitate funcțională |
...
| Gripande | Prindere/ |
| Grov fridskränkning och grov kvinnofridskränkning | Violarea gravă a vieții private și violarea gravă a integrității femeii |
...
| Hemförsäkring | Asigurare de domiciliu și a bunurilor menajere |
...
| Hyresrättighet | Drept de locație |
...
| Justitieombudsman (JO) | Ombudsmanul justiției/avocatul poporului |
...
| Konceptionstid | Perioada de concepție |
...
| Konsumenttjänst | Serviciul consumatorilor |
...
| Kostnadsyrkande | Solicitarea rambursării cheltuielilor |
...
| Latent skatteskuld | Datorie fiscală latentă |
...
| Människohandel | Trafic de ființe umane/persoane |
| Människorov | răpire |
...
| Näringsidkare | Om de afaceri/ antreprenor |
...
| Obehörig befattning med hemlig uppgift | Manipulare neautorizată cu informații secrete |
| Obestånd | insolvență |
...
| Olaga integritetsintrång | Violarea integrității vieții private |
...
| Personuppgiftsincident | Incident priv datele personale |
...
| Privaträttslig juridisk person | Persoană juridică în drept privat |
...
| Rättskapacitet / rättsförmåga | Capacitate judiciară |
...
| Reella tvångsmedel | Mijloace de constrîngere reale (ref la obiecte) |
...
| Riksåklagaren (RÅ) | Procuror general |
...
| Samadministrera | Administra împreună/co-administra |
...
| Särskild permission | Permisie specială |
...
| Skadeförsäkring | Asigurare de daune/avarii |
| Skadegörelse | distrugere |
| Skadestånd | Despăgubire |
| Skadeståndsmål | Cauza priv despăgubire |
| Skadeståndsrätt | Drept de despăgubire |
| Skadeståndsskyldighet | Obligație de despăgubire |
| Skälig tid | Timp rezonabil |
| Skäligen misstänkt för brottet | Bănuit de infracțiune pe motive plauzibile |
| Skänk | dar |
| Skatteavdragsbrott | Infr. privind deducerea din impozit |
| Skattebrott | Infracțiune fiscală |
| Skatteförseelse | Contravenție fiscală |
| Skattemål | Cauză fiscală |
| Skattemedel | Mijloace provenite din impozite/ resurse fiscale |
| Skatterätt | Drept fiscal |
| Skatteredovisningsbrott | Infr. Priv contabillitatea fiscală |
| Skattesubjekt | Subiect fiscal |
| Skatteuppgift | Informație fiscală |
| Skevdelningsregel | Regulă de partaj inegal |
| Skiftesman | Executor de partaj succesoral |
| Skiljeavtal | Acord arbitral |
| Skiljedom | Hotărâre arbitrală |
| Skiljedomare | Judecător arbitral |
| Skiljedomsprövning | Procedură arbitrală |
| Skiljeförfarande | Procedură arbitrală |
| Skiljeklausul | Clauză arbitrală |
| Skiljemål | Cauză arbitrală |
| Skiljeman | arbitru |
| Skiljenämnd | Comisie arbitrală |
| Skiljetvist | Litigiu arbitral |
| Skilsmässa / äktenskapsskillnad | Divorț / desfacerea căsătoriei |
| Skriftlig tredskodomsprocess | Proces în scris priv sentință în contumacie |
| Skriftväxling | Schimb de înscrisuri |
| Skuldebrev | Cambie/ poliță/ bilet la ordin |
| Skuldfrågan | Aspectul vinovăției |
| Skyddande av brottsling | Favorizarea infractorului |
| Skyddsgarant | Garant de protecție |
| Skyddsintresse | Interes de protecție |
| Skyddstillsyn | Supraveghere protectivă |
| Skyldighet | Obligația |
| Släkt i rätt upp- och nedåtstigande led | Rude în ordine ascendentă și descendentă directă |
| Släktskap | rudenie |
| Släktskapets närhet | Apropiere a gradului de rudenie |
| Släktskapsförhållande | Relație de rudenie |
| Släktutredning | Anchetă de rudenie |
| Slaveri | sclavie |
| Slutanföranden | Pledoarii finale |
| Sluten association | Asociere ? |
| Sluten ungdomsvård | Centru de detenție și reeducare a minorilor cu regim închis |
| Slutligt beslut | Decizie finală |
| Slutplädering | Pledoarie finală |
| Småhus | Casă mică |
| Smitning | Părăsirea locului accidentului |
| Smuggling | contrabandă |
| Social adekvans | Adecvență socială |
| Socialförsäkringsbalken | Codul asigurării sociale |
| Socialförsäkringsmål | Cauză de asigurare socială |
| Socialnämnd | Comisie socială |
| Sökande / adoptant | Solicitant/ adoptant |
| Solidariskt betalningsansvar | Responsabilitate solidară de plată |
| Spaning | filaj |
| Specialdomstol | Tribunal special |
| Specialexekution | Executare specială |
| Specialistkompetens | Competență de specialitate |
| Speciallagstiftning | Legislatie specială |
| Specialprocess | Proces special |
| Specialstraffrätt | Drept penal special |
| Speciell fastighetsrätt | Drept imobiliar special |
| Spioneri | spionaj |
| Spörsmål | chestiune |
| Språklag | lege lingvistică |
| Spridande av gift eller smitta | Răspândirea de substanțe toxice sau contagiuni |
| Stå faran för fastigheten | Asuma riscul pericolului imobilului |
| Stadfästa | A stabili |
| Stadgar | statut |
| Stadigvarande | Permanent/ constant |
| Stadigvarande bruk | Utilizare permanentă |
| Ställföreträdare | reprezentant |
| Ställföreträdarjäv | Incompatibilitatea unui reprezentant/înlocuitor |
| Ställningsfullmakt | Mandat de poziție |
| Stämma/stämning | A pune în mișcare o acțiune judiciară / a da în judecată |
| Stämning | Dare în judecată |
| Stämningsansökan | Rechizitoriu / cerere de dare în judecată |
| Stämningsman / delgivningsman | Agent procedural |
| Stämpelskatt | Taxa de intabulare |
| Stämpling till brott | Asociere în vederea comiterii unei infracțiuni |
| Standardavtal | Acord standardizat |
| Stängda dörrar / lyckta dörrar | Sedință secretă |
| Statens institutionsstyrelse | Direcția națională de îngrijire în instituții |
| Statens offentliga utredningar (SOU) | Investigații publice de stat |
| Statlig fastighetsskatt | Impozit imobiliar de stat |
| Statlig lönegaranti | Garanție de stat privind plata salariilor în caz de faliment |
| Statsbidrag | Subvenție de stat |
| Statsminister | Ministru de stat |
| Statsråd | ministru |
| Statsrådsberedning | Organ guvernamental în probleme multiple |
| Statsrätt | Drept de stat |
| Statssekreterare | Secretar de stat |
| Statsstöd | Sprijic economic de stat |
| Stiftelse | fundație |
| Stiftelseförordnande | Președinte al fundației |
| Stödperson | Persoană de sprijin |
| Stöld | furt |
| Störande av förrättning eller av allmän sammankomst | Tulburarea unei ceremoni sau a unei întruniri publice |
| Straff | pedeapsă |
| Straffbarhet | Pasibilitate de pedeapsă |
| Straffbelagd handling | Faptă penală |
| Strafflatitud/straffskala | Interval punitiv |
| Straffmätning | Stabilirea sentinței |
| Straffmätningsvärde | Valoarea pedepsei stabilite |
| Straffmyndig | Ajuns la vârsta responsabilității penale |
| Strafföreläggande | Ordonanță penală |
| Straffprocess/brottmål | Proces penal |
| Straffprocessrätt | Drept procesual penal |
| Straffrätt / kriminalrätt | Drept penal |
| Straffrättsvillfarelse | Ingnoranță în dreptul penal |
| Straffskala | Interval punitiv |
| Straffteori | Teorie punitivă |
| Straffvärde | Valoarea pedepsei |
| Straffvarning | Avertizare cu pedeapsa |
| Strikt ansvar | Responsabilitate strictă |
| Studiekamrat | Coleg de școală/ studii |
| Studielån | Împrumut de studii |
| Subjektiv avtalstolkning | Interpretare subiectivă a acordului |
| Subjektivt rekvisit | Recuzită subiectivă |
| Subventionsmissbruk | Abuz de subvenții |
| Successionsordningen | Legea constituționlă priv ordinea succesiunii la tron |
| Summarisk process | Proces sumar |
| Summariskt brottmålsförfarande | Procedură de judecată sumară în cauză penală |
| Svarande | Pârât |
| Svårighetsgrad: ringa, normalgrad, grov | Gradul de gravitate: minor, de grad normal, calificat/grav |
| Svaromål | Întâmpinare |
| Svek | Trădare/înșelare |
| Svensk författningssamling (SFS) | Cod statutar suedez |
| Sveriges advokatsamfund | Baroul de avocatură din SE |
| Svikande av försvarsplikt | Sustragere de la serviciul militar |
| Svikligt förfarande | Procedură frauduloasă |
| Svindleri | escrocherie |
| Swish | ? |
| Syn | Examinare (la fața locului) |
| Syskonbarn | Nepoți (de frați/surori) |
| Systematisk lagtolkning | Interpretare sistematică a legii |
| Täckningsprincipen | Principiul acoperirii |
| Tagande av muta | Luare de mită |
| Tagande av olovlig väg | Folosirea unui drum interzis |
| Tagande av utländskt understöd | Acceptarea / primirea de sprijin din străinătate |
| Talan | acuzarea |
| Talan om umgänge | Acțiune privind relații sociale |
| Talans utförande | Compunerea acuzării |
| Taleform | ? |
| Talerätt | Drept de a pune în mișcare o acțiune în justiție |
| Talman | Președintele parlamentului |
| Talmanspresidium | Prezidiul președintelui parlamentului |
| Tas i förvar | A fi luat în custodie publică |
| Taxeringsenhet | Unitate de taxare |
| Taxeringsvärde | Valoarea de taxare/ impozitare |
| Teckenspråk | Limba prin semne |
| Teleologisk lagtolkning | Lnterpretare teleologică |
| Terrorismsyfte | În scop terorist |
| Terroristbrott | Infracțiuni de terorism |
| Terroristmål | Cauză priv. terorism |
| Testamentsexekutor | Executor testamentar |
| Testamentstagare | Beneficiar testamentar |
| Testator | Testator |
| Tidsdelat boende | Locuință folosită alternant cu altcineva (timeshare) |
| Tidsfrist | Limită de timp |
| Tilläggsarbete | Muncă adițională |
| Tilläggsbouppteckning | Inventariu suplimentar al masei succesorale |
| Tilläggsprotokoll | Dosar adițional |
| Tilläggsyrkande | Cerere motivată complementară |
| Tillfällig vårdnadshavare | Custode interimar |
| Tillfälligt näringsförbud | Interdicție temporară de a exercita o activitate economică |
| Tillfälligt umgänge med umgängesstöd | Relații sociale temporare cu sprijin |
| Tillgänglighetsdelgivning | Notificare de disponibilitate |
| Tillgångsundersökning | Investigarea resurselor |
| Tillgrepp av fortskaffningsmedel | furtul in scop de folosintå al unui vehicul/mijloc de transport |
| Tillgreppsbrott | Infracțiune de sustragere |
| Tillräckliga skäl för att den misstänkte ska bli dömd | Motive suficiente pentru condamnarea suspectului |
| Tillståndsprövning | Acordarea autorizației în urma unei evaluări |
| Tillsyn över barn | Supravegherea copilului |
| Tillsynsmyndighet | Autoritate de supraveghere și control |
| Tillsynsområde | Zonă de supraveghere |
| Tillsynspermission | Permisie ? |
| Tilltalad | inculpat |
| Tillträda arv | A intra în posesia unei succesiuni |
| Tillträdesdag | Ziua/data intrării în posesie |
| Tillträdesförbud | Interdicție de a pătrunde |
| Tillträdesregister | ? |
| Tillväxtverket | Institutul național de dezvoltare |
| Timeshare | ? |
| Tingsrätt | Tribunal de primă instanță |
| Tjänande fastighet | Fond aservit |
| Tjänsteåtgärd | Măsură luată în exercitarea funcției |
| Tjänstefel | Practică incompetentă |
| Tjänsteman/tjänsteperson | funcționar |
| Tolkning av testamente | Interpretare a testamentului |
| Tolkningsdata | Informații interpretate |
| Tolkningsrätt | Drept de interpretare |
| Tomträtt | Drept de uzufruct al unui teren/ teren concesionat |
| Tomträtt med bostad | Locuință pe teren cu drept de uzufruct |
| Tomträttsavgäld | redevență |
| Tomträttsinnehavare | Posesorul dreptului de uzufruct al unui teren |
| Tortyr | tortură |
| Totalförsvarspliktiga | ? |
| Tradera / tradition | A transmite mai departe/ tradiție |
| Trafikbrott | Infracțiune de trafic |
| Trafikskadeersättning | Compensație pt daune cauzate în trafic |
| Trakasseri | Tracaserie/hărțuire |
| Trångmål | Ananghie/ strâmtorare |
| Transport | transport |
| Transportmedel på plats | Mijloc de transport la fața locului |
| Tredimensionell fastighet | Imobil tredimensional |
| Tredimensionell fastighetsbildning | ? |
| Tredimensionellt fastighetsutrymme | Spațiu imobiliar tredimensional |
| Tredje man | Persoană terță |
| Tredskodom | Sentință în contumacie |
| Treinstansordning | Ordine de trei instanțe |
| Tribunal | tribunal |
| Tro och heder | Credință și onoare |
| Trolöshet vid förhandling med främmande makt | Iloialitate în cadrul demersurilor cu forță străină |
| Trolovning / förlovning | logodnă |
| Trossamfund | Cult religios |
| Trosuppfattning | Convingere religioasă |
| Tryckfrihetsförordningen | Legea constitutională privind libertatea presei |
| Trygghet för barn | Securitate/siguranță pt copii |
| Tullavgift | Taxă vamală |
| Tullverket | Direcția vamală |
| Turordning | Ordine de rând |
| Tvåinstansjäv | Incompatibilitate în două instanțe |
| Tvång | Coerciție / silire |
| Tvångsäktenskap | Căsătorie forțată/silită |
| Tvångsarbete | Muncă silnică |
| Tvångsåtgärd | Măsură coercitivă/silită |
| Tvångsbodelning | Partaj silit |
| Tvångsförfarande | Procedură silită |
| Tvångsinlösen / expropriation | expropriere |
| Tvångsinlösning | Răscumpărare silită |
| Tvångslikvidation | Lichidare silită |
| Tvångsmedel | Măsuri asigurătorii |
| Tvångsomhändertagande | Luare silită în îngrijire |
| Tvångsskifte | Partaj silit |
| Tvåpartsprocess / tvåpartsmål | Cauză care include două părți (doi actori) |
| Tvegifte / bigami | bigamie |
| Tvegifte och olovligt ingående av äktenskap | Bigamie și căsătorie ilegală |
| Tvistemål | litigiu |
| Tvistlösningsorgan | Organ de rezolvare a unui litigiu |
| Tystnadsplikt | Obligația de a păstra secretul profesional |
| Umgänge med barn | Relații sociale cu minorul |
| Umgängesförälder | Părinte nerezident |
| Umgängesrätt | Drept de a întreține relații sociale |
| Underhåll | Pensie de întreținere |
| Underhållsbidrag | Pensie de întreținere |
| Underhållsskyldighet | Obligația de întreținere |
| Underhållsstöd | Subvenție de întreținere a minorului |
| Underhandsackord | Acord voluntar de plată |
| Underlåtenhet | Omisiunea de a acționa/neacțiune/neîndeplinirea unei obligații |
| Underlåtenhet att avvärja allmänfara | Omisiunea prevenirii unui pericol public |
| Underlåtenhet att avvärja rättsfel | Omiterea evitării unei erori judiciare |
| Underrätt | Judecătorie / instanță inferioară |
| Underrättelse | notificare |
| Underrättelse | Notificare/comunicare |
| Underrättelseverksamhet | Activitate de inteligență |
| Undersökningsplikt | Obligația de examinare amănunțită |
| Underställningsmål | ? |
| Unga lagöverträdare | Delicvenți minori |
| Unga myndiga | Persoane majore tinere |
| Ungdomsåklagare | Procuror specializat în cuaze cu minori |
| Ungdomsärende | Caz cu minor |
| Ungdomsmål | Cauză cu minor |
| Ungdomsövervakning | Supravegherea în libertate a unui minor |
| Ungdomsrabatt | Rabat acordat minorilor |
| Ungdomstjänst | Muncă in folosul comunității pt minori |
| Ungdomsvård | Îngrijirea specializată pt recuperarea delicvenților minori |
| Unionsrätt | Drept în cadrul UE |
| Universell jurisdiktion | Jurisdicție universală |
| Universell testamentstagare | Beneficiar testamentar universal |
| Uppbördsmyndighet | Autoritate de colectare |
| Uppdragsavtal | Acord privind misiunea/sarcina |
| Uppdragsfullmakt | Procură priv sarcina/ misiunea |
| Uppdragsgivare | Contractant / |
| Uppföljningsrapport | Raport de monitorizare |
| Upphandling | Achiziție publica |
| Upphandlingsmål | Cauză de achiziționare publică |
| Upphandlingsregel | Regulă de achiziționare publică |
| Upphovsrätt | Dreptul de autor |
| Uppläggningskostnad | Cost de administrare |
| Upplåtelsetid | Perioada de concesionare |
| Upplopp | Revoltă publică |
| Uppmaning till självmord | Incitare la sinucidere |
| Upprätta bodelningshandling | Întocmi document de partaj |
| Upprätta testamente | Întocmirea testamentului |
| Uppror | Răscolă/rebeliune |
| Uppsåt | intenție |
| Uppsåtsbegrepp | Noțiunea de intenție |
| Uppsikt över barn | Supraveghere a copiilor |
| Uppskjuten frigivning | Liberare amânată |
| Uppskov | Amânare |
| Uppskovsbelopp | Suma amânată |
| Uppvigling | instigarea publică si apologia infractiunilor |
| Urkund | Înscris oficial |
| Urkundsförfalskning | Fals intelectual în înscrisuri oficiale |
| Ursprungsbostad | Locuința inițială |
| Utandningsprov | Probă din aerul expirat |
| Utbildning för terrorism eller särskilt allvarlig brottslighet | Educare pt terorism sau infr deosebit de gravă |
| Utbyte / surrogat | Surogat/substitut |
| Utdelning | Câștig/ randament economic |
| Utdelningsförslag | Propunere de dividend/ împărțire |
| Utdelningsprocent | Procent de dividend |
| Uteslutning | Excludere |
| Utfästelse | Promisiune/făgăduială/făgăduință |
| Utfästelse att inte återkalla testamente | Promisiune de a nu revoca testamentul |
| Utlämning | extrădare |
| Utlandsspioneri | Spionerie în străinătate / a unei țări străine |
| Utlänning | străin |
| Utlännings- och medborgarskapsmål | Cauză privind străin și cetățenie |
| Utlänningsärende | Caz priv persoane străine |
| Utmätning | Executare silită |
| Utmätning på distans | Executare silită la distanță |
| Utmätningsfri | Căruia nu se poate aplica executare silită |
| Utnyttjande av barn för sexuell posering | Exploatarea minorului pt fotografiere de nat sexuală |
| Utnyttjande av barn genom köp av sexuell handling | Exploatarea minorului prin cumpărarea de serviciu sexual |
| Utökad frigång | Ieșire liberă sporită în afara penitenciarului |
| Utom rimligt tvivel att den tilltalade gjort sig skyldig till brottet | În afara oricărei îndoieli plauzibile că inculpatul s-a făcut vinovat de comiterea infracțiunii |
| Utöva tillsyn | A exercita supraveghere |
| Utpressning | șantaj |
| Utreda brott | A investiga/ ancheta o infracțiune |
| Utredningsarbete | Muncă de investigare |
| Utredningshäktning | Arestare preventivă în decursul urmăririi penale |
| Utredningstekniskt skäl | Motive tehnice de investigare |
| Utskänkningstillstånd | Permis de a servi alcool |
| Utslag | Rezultat, neaprobare |
| Utslussningsåtgärd | Măsură de trecere treptată din detenție în libertate |
| Utsökningsbalken | Codul de executare silitå |
| Utsökningsrätt | Drept de executare silită |
| Utvisning på grund av brott | Expulzare din cauza comiterii infracțiunilor |
| Väcka åtal | A iniția o acțiune judiciară |
| Val | alegeri |
| Valadministration | Administrație electorală |
| Våld eller hot mot tjänsteman | ultraj |
| Våldsamt motstånd | Împotrivire violentă |
| Våldsamt upplopp | Revoltă publică violentă/răzmeriță |
| Våldsbejakande extremism | Extremism violent |
| Våldsbrott | Infaracțiune violentă |
| Våldtäkt | viol |
| Våldtäkt mot barn | Viol cu minor |
| Vållande till annans död | Ucidere din culpă |
| Vållande till kroppsskada eller sjukdom | Vătămare corporală sau pricinuirea bolii din culpă |
| Vallning | Escortarea infractorului la locul infracțiunii |
| Valnämnd | Comisie electorală |
| Valprövningsnämnd | Comisie de evaluare electorală |
| Vanlig handräckning | Asistență executivă normală |
| Vanlig skuldsanering | Asanare a datoriilor |
| Vapenregister | Registrul armelor |
| Väpnat hot mot laglig ordning | Amenințare armată contra ordinii legale |
| Vård med / utan särskild utskrivningsprövning | Asistență medicală cu/fără examinare special la eliberare |
| Vårda boet | Îngriji (avea grijă de) masa succesorală |
| Värdekonfiskation | Confiscare de valori |
| Vårdnad | custodie |
| Vårdnadshavare | custode |
| Vårdnadsöverföring | Transferarea custodiei |
| Vårdnadstvist | Litigiu de custodie |
| Vårdslös finansiering av mutbrott | Finanțare neglijentă în cadrul infr de dare de mită |
| Vårdslöshet | neglijență |
| Vårdslöshet i trafik | Neglijență în trafic |
| Vårdslöshet med gift och smittämne | "Neglijență în manipularea subst toxice sau a subst |
| Contaminatoare ( agenților patogeni)" |
| Vårdslöshet med hemlig uppgift | Neglijență în manipularea informațiilor secrete |
| Vårdslöshet med narkotika | Neglijență cu produse narcotice |
| Vårdslöshet mot borgenärer | Tratament inechitabil al unui creditor |
| Vårdvistelse | ? |
| Varning | Avertisment |
| Varumärke | Marcă înregistrată |
| Vatten- och avloppsmål | Cauză în probleme de apă și canalizare |
| Vattentjänst | Servicii de alimentare cu apă |
| Vattenverksamhet | Activitate de alimentare cu apă |
| Växel | Poliță/trată |
| Växelvis boende | Locuire alternantă |
| Vedergällningsteori / Retributiv straffteori | Teorie punitivă retributivă |
| Vederlagsregel | Regulă compensatorie |
| Verksledning | Conducerea unui directorat/oficiu |
| Verkställa utdömd påföljd | Executarea unei sancțiuni dispusă prin sentință |
| Verkställande direktör | Director executiv |
| Verkställighet | executare |
| Verkställighetsstadiet | Stadiu executiv |
| Victim Identification | Indentificarea victimei |
| Videodokumentering | Documentare video |
| Vigsel | Cununie/căsătorie |
| Vigselbevis | Certificat de căsătorie |
| Vigselförrättare | Oficiantul căsătoriei |
| Vigselordning | Ordinea actului /procedurii de căsătorie |
| Vigseltillstånd | Permis de căsătorie |
| Viljeförklaring | Declarație intențională |
| Villfarelse | Eroare, înșelare, amăgire |
| Villkor i testamente | Condiții la testament |
| Villkor vid gåva | Clauză la donație |
| Villkorlig dom | Sentință cu suspendarea executării |
| Villkorlig frigivning | Liberare condiționată |
| Villkorligt frigiven | Liberat condiționat |
| Vilseledande till äktenskapsresa | Inducere în eroare priv călătorie în vederea încheierii unei căsătorii |
| Vite | Amendă judiciară |
| Vittne | martor |
| Vittnesbekräftelse | Confirmare prin martor |
| Vittnesed | Jurământ de martor |
| Vittneskallelse | Citația martorului |
| Vittnesplikt | Obligația de a depune mărturie |
| Vittnesstöd | Organizație de sprijin a părților vătămate / martorilor |
| Vittnesutsaga / vittnesberättelse / vittnesattest | Declarația martorului |
| Yppandeförbud | Impunere a tăcerii |
| Yrkande | Cerere motivată |
| Yrkeshemlighet | Secret profesional |
| Yrkesmässig sjöfart | Navigație profesională |
| Yrkesmässigt | profesional |
| Yrkesverksam | Activ profesional |
| Yttersta vilja | Ultima dorință expresă a defunctului |
| Yttrandefrihet | Libertate de exprimare |
| Yttrandefrihetsgrundlagen | Legea constituțională priv libertatea de expresiei
